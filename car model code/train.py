...
def train(aug,trainX,trainY,testX,testY,args):
    ...
    plt.title("Training Loss and Accuracy on car model classifier")
    plt.xlabel("Epoch #")
...
#python train.py --dataset_train ../../car model/train --dataset_test ../../car model/test --model traffic_sign.model
